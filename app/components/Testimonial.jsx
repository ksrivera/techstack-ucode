  ...
  return (
    <div>
        ...
        <section className="mb-32 text-center">
            ...
            <div className="grid mb-6 lg:mb-0">
                <div
                className="relative block rounded-lg bg-slate-900 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
                <div className="flex">
                    <div
                ...
                <div className="p-6">
                    <h5 className="mb-2 text-lg font-bold">Emma Smith</h5>
                    ...
                    <p>
                    I have been using TechStack website for several months now, and I am incredibly impressed with their services. As a tech enthusiast, I rely on accurate and up-to-date information, and this website delivers just that. The articles are well-researched, easy to understand, and cover a wide range of tech topics.
                    </p>
                </div>
                </div>
            </div>
            ...
            <div className="mb-6 lg:mb-0">
                ...
                <div className="p-6">
                    ...
                    <p>
                    I can confidently say that TechStack has become my tech companion. Being a non-tech savvy person, I often found myself overwhelmed by the rapidly evolving technology landscape. However, this website has been a game-changer for me. The easy-to-follow tutorials and guides have empowered me to troubleshoot issues on my own and learn new tech skills. Thanks to TechStack, I now feel more confident in using and understanding various tech devices and software. Their dedication to simplifying complex concepts is truly commendable. Keep up the great work!
                    </p>
                </div>
                </div>
            </div>
            ...
            <div className="mb-0 grid">
                ...
                <div className="p-6">
                    <h5 className="mb-2 text-lg font-bold">Noah Smith</h5>
                    <h6 className="mb-4 font-medium text-primary">
                    Public Relations
                    </h6>
                    <ul className="mb-6 flex justify-center">
