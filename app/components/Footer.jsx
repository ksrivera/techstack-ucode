...
<footer className="bg-gray-900">
    <div className="container px-6 py-8 mx-auto">
        ...
        <Link href='/' className="flex items-center">
            ...
            <p className="max-w-md mx-auto mt-4 text-gray-500 dark:text-gray-400">Where Web Development Meets Technological Excellence</p>
 ...
 {/*            <div className="flex flex-col mt-4 sm:flex-row sm:items-center sm:justify-center">
        ...
        <div className="flex flex-col items-center sm:flex-row sm:justify-between">
            ...
            <div className="flex mt-3 -mx-2 sm:mt-0 p-1">
                <a href="#" className="mx-2 p-2 text-sm text-gray-500 hover:text-violet-400 shadow-lg rounded-lg hover:shadow-violet-400 transition-colors duration-300" aria-label="Reddit"> Teams </a>

                <a href="#" className="mx-2 p-2 text-sm text-gray-500 hover:text-violet-400 shadow-lg rounded-lg hover:shadow-violet-400 transition-colors duration-300" aria-label="Reddit"> Privacy </a>

                <a href="#" className="mx-2 p-2 text-sm text-gray-500 hover:text-violet-400 shadow-lg rounded-lg hover:shadow-violet-400 transition-colors duration-300" aria-label="Reddit"> Cookies </a>
            </div>
        </div>
    </div>
</footer>
